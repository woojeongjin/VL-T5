...
from pretrain_vae_data import get_loader
from utils import LossMeter
from dist_utils import reduce_dict

import wandb
from comm import init_distributed_mode
...
class Trainer(TrainerBase):
    def __init__(self, args, train_loader=None, val_loader=None, test_loader=None, train=True):
        ...
        from pretrain_vae_model import VLT5Pretraining, VLBartPretraining
    ...
    def train(self):
        ...
        if self.verbose:
            ...
            if 't5' in self.args.backbone:
                project_name = "VLT5_Pretrain_VAE"
...
def main_worker(gpu, args):
    ...
    train_loader = get_loader(
        ...
        distributed=args.distributed, is_master=args.is_master,
